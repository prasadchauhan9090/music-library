...
import { UploadCloud, Folder, FileAudio, CheckCircle2, AlertCircle, Loader2, X, RefreshCw } from 'lucide-react';
        ...
        <div className="flex items-center justify-between pb-4 border-b border-white/10">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-400">Add local audio files directly to your private library</p>
            </div>
          </div>
